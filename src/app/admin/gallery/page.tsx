...
function UploadCard({ isMobile, setView, handleUpload, isUploading, uploadProgress, file, description, setFile, setDescription, previewUrl, setPreviewUrl, resetForm }: any) {
     ...
     <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {isMobile ? (
                <Button variant="default" size="sm" onClick={() => (setSelectionMode as any)('form')}>
            ...
            {selectionMode ? (
                ...
                <Button variant="outline" onClick={() => setSelectionMode(true)} disabled={!sortedImages || sortedImages.length === 0}>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            ...
            {sortedImages?.map((img: GalleryImage) => {
             ...
             {!isLoadingImages && sortedImages?.length === 0 && (
...
export default function AdminGalleryPage() {
  ...
  return (
    <div className="space-y-8">
       {isMobile ? (
          view === 'form' ? <UploadCard {...uploadCardProps} /> : <GalleryListCard {...galleryListProps} />
       ) : (
        <>
            <UploadCard {...uploadCardProps} />
            <GalleryListCard {...galleryListProps} />
        </>
       )}
    </div>
  );
